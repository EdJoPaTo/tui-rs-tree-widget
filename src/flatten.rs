...
use crate::{GenericTreeItem, Node};

/// Recursive implementation of [`TreeData::get_nodes`](crate::TreeData::get_nodes) for [`GenericTreeItem`]s.
///
/// `current` starts empty: `&[]`
#[must_use]
pub fn flatten<Item: GenericTreeItem>(
